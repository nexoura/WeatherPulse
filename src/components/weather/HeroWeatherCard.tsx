  ...
  return (
    ...
    >
      <GlassCard strong className="relative isolate overflow-hidden p-4 sm:p-6 md:p-10 ring-glow">
        ...
        {/* ── Top row: location + date | action buttons ── */}
        ...
        {/* ── Main content: temp block + weather icon side-by-side ── */}
        <div className="mt-4 flex items-start justify-between gap-4">
          ...
          {/* Weather icon — always visible on the right of the temp block */}
        ...
        {/* ── Stats grid — always full-width below the temp block ── */}
        <div className="mt-5 grid grid-cols-2 gap-x-4 gap-y-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7">
          {(
            [
              {
                label: "Humidity",
              ...
              return (
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <span className="mt-1 text-base font-semibold tracking-tight text-foreground group-hover:text-primary transition-colors">
                      {s.value}
                    </span>
            ...
            return (
              <div key={idx} className="flex flex-col">
                ...
                <span className="mt-1 text-base font-semibold tracking-tight text-foreground">
                  {s.value}
                </span>
